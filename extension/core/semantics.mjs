...
const groups=[
 ...
 ['证件号码','身份证号码','身份证号'],['学校','学校名称','毕业学校','毕业院校','院校名称','university','school name'],['学院','学院名称','院系'],
 ...
 ['岗位职责','实习内容','工作内容','工作职责'],['项目描述','项目介绍','项目简介','project description'],
...
export function scope(s=''){
 for(const [key,re] of [['contact',/紧急联系/],['family',/家庭|亲属|家属/],['education',/教育|学历|本科|硕士|研究生|博士|education|academic/i],['work',/实习|工作经历|employment|work experience/i],['project',/项目|project/i],['certificate',/资格|证书/],['award',/获奖|奖励|奖惩/],['language',/语言|外语/],['personal',/基本|个人|personal|basic information/i]])if(re.test(s))return key;
 return '';
}

...
chrome.runtime.onMessage.addListener((m,sender,reply)=>{
 ...
 if(m.type==='resume-scan'){const snapshot=await engine(tabId,'scan');await api('/snapshot',{snapshot,commandId:m.commandId});return api('/plan',{});}
